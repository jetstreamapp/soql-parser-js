import { Query, Subquery, FieldFunctionExpression, Condition, LiteralType } from './models/SoqlQuery.model';
import {
  ComposeField,
...
import { Condition_fieldContext } from './generated/SOQLParser';
...
export function getWhereValue(value: any | any[], literalType?: LiteralType) {
